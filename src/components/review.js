            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="rbt-buy-now-content text-center">
                        <h2 class="title color-white">Globally trusted by hundreds of Students</h2>
                        <h4 class="subtitle color-white">Learn Smarter ☕ Create Better ⭐ Build Faster ⚡</h4>
                        ...
                        <span class="label-text color-white d-block text-uppercase">How will This course benefit to  me?</span>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            <span class="subtitle bg-primary-opacity">A FEW WORDS FROM OUR STUDENTS</span>
                            <h2 class="title">What People Are <br/> Saying About
                                <span class="header-caption">
                                    <span class="cd-headline zoom">
                                        <span class="cd-words-wrapper">
                                            <b class="is-visible theme-gradient">Classes.</b>
                                            <b class="is-hidden theme-gradient">HiStudy  </b>
                                        </span>
                                </span>
                                </span>
                            </h2>
